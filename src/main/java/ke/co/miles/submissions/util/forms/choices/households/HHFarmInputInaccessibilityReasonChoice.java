 ...
 * @version 1.0
 */
public enum HHFarmInputInaccessibilityReasonChoice {
    ...
    private HHFarmInputInaccessibilityReasonChoice(String id, String name) {
        this.id = id;
        this.name = name;
    }

    public static HHFarmInputInaccessibilityReasonChoice findById(String id) {
        switch (id) {
    ...
    public static List<HHFarmInputInaccessibilityReasonChoice> findBySpaceSeparatedIds(String idsString){
        List<HHFarmInputInaccessibilityReasonChoice> choices = new ArrayList<>();
        Integer id;
        for (String s : idsString.split("\\s")) {
            if(s != null){
                HHFarmInputInaccessibilityReasonChoice l = findById(s);
                if(l != null){
                    choices.add(l);
                }
            }
