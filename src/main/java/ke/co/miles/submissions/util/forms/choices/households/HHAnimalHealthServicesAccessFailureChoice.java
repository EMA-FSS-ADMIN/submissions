 ...
 * @version 1.0
 */
public enum HHAnimalHealthServicesAccessFailureChoice {
    ...
    private HHAnimalHealthServicesAccessFailureChoice(String id, String name) {
        this.id = id;
        this.name = name;
    }

    public static HHAnimalHealthServicesAccessFailureChoice findById(String id) {
        switch (id) {
    ...
    public static List<HHAnimalHealthServicesAccessFailureChoice> findBySpaceSeparatedIds(String idsString){
        List<HHAnimalHealthServicesAccessFailureChoice> choices = new ArrayList<>();
        Integer id;
        for (String s : idsString.split("\\s")) {
            if(s != null){
                HHAnimalHealthServicesAccessFailureChoice l = findById(s);
                if(l != null){
                    choices.add(l);
                }
            }
