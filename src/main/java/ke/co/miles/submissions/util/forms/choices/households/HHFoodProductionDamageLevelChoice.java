 ...
 * @version 1.0
 */
public enum HHFoodProductionDamageLevelChoice {
    ...
    private HHFoodProductionDamageLevelChoice(int id, String name) {
        this.id = id;
        this.name = name;
    }
    
    public static HHFoodProductionDamageLevelChoice findById(Integer id){
