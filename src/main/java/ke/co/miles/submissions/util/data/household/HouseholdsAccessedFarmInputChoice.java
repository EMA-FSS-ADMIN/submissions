 ...
 * @version 1.0
 */
public enum HouseholdsAccessedFarmInputChoice {
    ...
    private HouseholdsAccessedFarmInputChoice(String id, String name) {
        this.id = id;
        this.name = name;
    }

    public static HouseholdsAccessedFarmInputChoice findById(String id) {
        switch (id) {
    ...
    public static List<HouseholdsAccessedFarmInputChoice> findBySpaceSeparatedIds(String idsString){
        List<HouseholdsAccessedFarmInputChoice> choices = new ArrayList<>();
        Integer id;
        for (String s : idsString.split("\\s")) {
            if(s != null){
                HouseholdsAccessedFarmInputChoice l = findById(s);
                if(l != null){
                    choices.add(l);
                }
            }
