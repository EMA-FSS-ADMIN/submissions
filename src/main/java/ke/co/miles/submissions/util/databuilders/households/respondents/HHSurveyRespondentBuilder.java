                ...
                case MALE:
                    categoricalObservations.add(
                            new PhenomenonBuilder()
                                    ...
                                    .phenomenonTypeId(PhenomenonEnum.HH_SURVEY_RESPONDENT_IS_MALE_YES.getPhenomenonTypeId())
                                    .phenomenonType(PhenomenonEnum.HH_SURVEY_RESPONDENT_IS_MALE_YES.getPhenomenonType())
                ...
                case FEMALE:
                    categoricalObservations.add(
                            new PhenomenonBuilder()
                                    ...
                                    .phenomenonTypeId(PhenomenonEnum.HH_SURVEY_RESPONDENT_IS_FEMALE_YES.getPhenomenonTypeId())
                                    .phenomenonType(PhenomenonEnum.HH_SURVEY_RESPONDENT_IS_FEMALE_YES.getPhenomenonType())
