...
public class EnumeratorBuilder {
                ...
                case MALE:
                    categoricalObservations.add(
                            new PhenomenonBuilder()
                                    ...
                                    .phenomenonTypeId(PhenomenonEnum.HH_DATA_ENUMERATOR_IS_MALE_YES.getPhenomenonTypeId())
                ...
                case FEMALE:
                    categoricalObservations.add(
                            new PhenomenonBuilder()
                                    ...
                                    .phenomenonTypeId(PhenomenonEnum.HH_DATA_ENUMERATOR_IS_FEMALE_YES.getPhenomenonTypeId())
                                    .phenomenonType(PhenomenonEnum.HH_DATA_ENUMERATOR_IS_FEMALE_YES.getPhenomenonType())
    ...
    public Enumerator build() {
        ...
        return new Enumerator(name, phone, categoricalObservations);
    }
}
