 ...
 * @version 1.0
 */
public enum HouseholdMainFoodSourceChoice {
    ...
    private HouseholdMainFoodSourceChoice(int id, String name) {
        this.id = id;
        this.name = name;
    }
    
    public static HouseholdMainFoodSourceChoice findById(int id){
        switch(id){
