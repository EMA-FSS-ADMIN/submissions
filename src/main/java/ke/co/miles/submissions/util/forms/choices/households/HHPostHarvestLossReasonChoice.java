 ...
 * @version 1.0
 */
public enum HHPostHarvestLossReasonChoice {
    ...
    private HHPostHarvestLossReasonChoice(int id, String name) {
        this.id = id;
        this.name = name;
    }
    
    public static HHPostHarvestLossReasonChoice findById(int id){
        switch(id){
    ...
    public static List<HHPostHarvestLossReasonChoice> findBySpaceSeparatedIds(String idsString){
        List<HHPostHarvestLossReasonChoice> choices = new ArrayList<>();
        Integer id;
        for (String s : idsString.split("\\s")) {
            if(s != null){
                ...
                HHPostHarvestLossReasonChoice l = findById(id);
                if(l != null){
                    choices.add(l);
                }
            }
